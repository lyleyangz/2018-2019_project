export default {
    buy:{
        ...
        errMes:{
            ...
            mes4: "You can't buy more than {0} bits after buying a small number",
            mes5: "You can't buy more than {0} bits after a small number of buying.",
            mes6: "Price has been refreshed, please resubmit"
        }
    },
    pay:{
        order:{
