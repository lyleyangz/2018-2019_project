        ...
        <Card>
            ...
            <div class="cnt">
                <div class="item">
                    ...
                    <span>
                        <RadioGroup v-model="params.pointType" >
                ...
                <div class="item" v-if="params.pointType==1">
                    ...
                    <span>
                        <Select style="width:350px" v-model="params.code" placeholder="请选择" :disabled="isEdit">
                ...
                <div>
                    <div class="item">
                        ...
                        <span>
                            <input v-limitNum="6" class="ivu-input" v-model.trim="params.score" style="width:350px;"/>
