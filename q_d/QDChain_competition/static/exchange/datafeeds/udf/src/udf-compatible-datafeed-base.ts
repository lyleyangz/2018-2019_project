...
export class UDFCompatibleDatafeedBase implements IExternalDatafeed, IDatafeedQuotesApi, IDatafeedChartApi {
	...
	protected _symbols: LibrarySymbolInfo = defaultSymbols();
	 ...
	 */
	protected constructor(datafeedURL: string, quotesProvider: IQuotesProvider, requester: Requester, updateFrequency: number = 10 * 1000,param: RequestParams) {
...
function defaultConfiguration(): UdfCompatibleConfiguration {
	return {
		...
		"supports_marks":false, // 禁止 marks接口的请求
		"supports_timescale_marks":false,// 禁止 timescale_marks接口的请求
		"supports_time":false,// 禁止 time接口的请求
		"exchanges":[
...
function defaultSymbols(): LibrarySymbolInfo {
	return {
		ticker: 'AAPL',
		name: 'AAPL',
		full_name: 'APPL',
